...
import serial # to transmit data to arduino
...
def fileSearch():
	...
	fileEntry=[]
	for file in os.listdir("SampleGestuaaaares"):
		...
		while True:
			...
			if keyboard.is_pressed('a'):
					try:
						...
						new_text+=img_text
						if not os.path.exists('C:\\Users\\RAHUL DEO\\Desktop\\Source Code\\TempGest'):
							os.mkdir('./TempGest')
